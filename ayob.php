	...
	<table class="colored">
	    ...
	    <div id="page" class="hfeed site">
                <header id="header" class="site_header" role="banner">
					...
					<ul>
												<li class="fb"><a target="_blank" href="https://www.facebook.com/mariam.maryouma.5249">Facebook</a></li>																		<li class="lnkd"><a target="_blank" href="https://www.linkedin.com/in/sakly-ayoub-ba269391">Linkedin</a></li>																		<li class="skp"><a target="_blank" href="skype:saklyayoub@live.com" class="skp">Skype</a></li>																								
	...
	<div id="primary" class="content_area">
			...
			<section id="profile" class="section profile_section first odd">
				<div class="section_header profile_section_header opened">
					...
					<div id="profile_header">
                        <div id="profile_user">
                        	                            <div id="profile_photo"><img src="C:\Users\mariem\Desktop\47380383_1213484342140710_5035531593268068352_n.jpg" alt="Mariem Soudeni" /></div>
                                                        <div id="profile_name_area">
                                <div id="profile_name">
								<h1 id="profile_title">
								 <span class="firstname" id="demo">mariem
									
																					</span><input type="text" id="moninput" value="name"  name="chng" style="display:none;" onblur="change2()"/></h1>
      ...
      <script>
        ...
        $(document).ready(function(){
         $(".td").click(function(t) {
			c=$(this).text();
			$(this).replaceWith('<input type="text" class="tst" name="inp">');
			$(".tst").val(c);
			
		$(".tst").blur(function(t) {
		k=$(this).val();	
		$(this).replaceWith('<span class="th">' + $(this).val() + '</span>');
		$.ajax({
    type: 'POST',
    url: '127.0.0.1/cv/fich1.php',
    data: $(".tst").serialize() ,//pour envoyer tous les input du formulaire ayant l'id= mon_form
      dataType: "json"//type de données de retour
                                            ...
                                            <span class="th">Nom:</span><span class="td" id="res" ><?php 
                                 ...
                                 <div class="profile_row" >
								<span class="th">Date de naissance:</span><span class="td" id="res" onclick="afficher_input2(this)">22/11/1998</span>
								
							     </div>
							
                                                        							
                                                        							<div class="profile_row">
								<span class="th">Téléphone:</span><span class="td" id="res">+21624419772</span>
								
							</div>
                                                        							<div class="profile_row">
								<span class="th">Email:</span><span class="td" id="res">mariemsoudani@gmail.com</span>
							
							</div>
                                                        							<div class="profile_row">
								<span class="th">Site Internet:</span><span class="td" d="res"><a href="http://mind.engineering">http://mind.engineering</a></span>
				...
				<div class="section_body profile_section_body">
					<div class="proile_body">
						<p>Mind Engineering est une agence spécialisée dans la conception de solutions logicielles innovantes, performantes et sur mesure. Nous sommes une équipe de développeurs, designers et chefs de projet, tous experts, passionnés par notre métier et fiers des solutions que nous offrons à nos partenaires.</p>
					</div>			
				</div>
			</section>	
...
</aside><aside id="skills-widget-6" class="widget widget_skills"><h3 class="widget_title">SYSTÈME DE GESTION DE CONTENUE</h3>			
		<div class="widget_inner style_1">
			<div class="skills_row odd first"><span class="caption">WordPress</span><span class="progressbar"><span class="progress" style="background-color:#1297E0;" rel="98%"><span class="value">98%</span></span></span></div><div class="skills_row even"><span class="caption">Prestashop</span><span class="progressbar"><span class="progress" style="background-color:#5EFAF7;" rel="80%"><span class="value">80%</span></span></span></div><div class="skills_row odd"><span class="caption">Drupal</span><span class="progressbar"><span class="progress" style="background-color:#F1C40F;" rel="60%"><span class="value">60%</span></span></span></div><div class="skills_row even"><span class="caption">Magento</span><span class="progressbar"><span class="progress" style="background-color:#5EFAF7;" rel="80%"><span class="value">80%</span></span></span></div>		</div>
</aside><aside id="skills-widget-7" class="widget widget_skills"><h3 class="widget_title">CLOUD</h3>			
		<div class="widget_inner style_1">
			<div class="skills_row odd first"><span class="caption"> Virtualmin</span><span class="progressbar"><span class="progress" style="background-color:#1297E0;" rel="98%"><span class="value">98%</span></span></span></div><div class="skills_row even"><span class="caption"> Webmin</span><span class="progressbar"><span class="progress" style="background-color:#39D5FF;" rel="90%"><span class="value">90%</span></span></span></div><div class="skills_row odd"><span class="caption">Cloudmin</span><span class="progressbar"><span class="progress" style="background-color:#F1C40F;" rel="50%"><span class="value">50%</span></span></span></div><div class="skills_row even"><span class="caption">OwnCloud </span><span class="progressbar"><span class="progress" style="background-color:#39D5FF;" rel="90%"><span class="value">90%</span></span></span></div>		</div>
